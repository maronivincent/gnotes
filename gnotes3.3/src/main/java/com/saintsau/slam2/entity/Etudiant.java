package com.saintsau.slam2.entity;
...
public class Etudiant {
	...
	public Etudiant(String nom, Long numero, Set<Matiere> matieres) {
		super();
		this.nom = nom;
		this.numero = numero;
	...
	@OneToMany(fetch = FetchType.EAGER,mappedBy = "etudiant", cascade = CascadeType.ALL)
